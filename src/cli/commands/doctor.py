...
def main(
    ...
    from models.doctor import DoctorFixInput, DoctorInput  # noqa: PLC0415
    from services.doctor_svc import doctor, doctor_fix  # noqa: PLC0415

    result = doctor_fix(DoctorFixInput()) if fix else doctor(DoctorInput())
