...
The [connect box](https://daysurface.com/#connect) on the product site picks the
right flow for your client:
...
Clients that read a config file (Claude Cowork/Desktop 0.7+, Cursor, etc.) can
also be pointed at the endpoint directly:
