---
title: Tools
description: The 34 Gmail, PDF, and webhook tools your assistant gets once connected
---
...
| Tool | Description |
|------|-------------|
| `pdf_open` **UI** | Open a PDF into a server-side editing session and return its fields and a `doc_id`. |
...
See [Gmail Webhooks](/docs/gmail-webhooks) for the event payloads and signature
scheme.
