...
[`common/global_config.yaml`](https://github.com/Miyamura80/DaySurface/blob/main/common/global_config.yaml)
...
defaults - **read the headers at runtime; don't hard-code limits.**
