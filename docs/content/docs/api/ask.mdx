...
data: {"message_type":"result","index":0,"item":{"@type":"TechArticle","@context":"https://schema.org","name":"Setup","url":"https://daysurface.com/docs/mcp/setup","description":"...","text":"..."}}
  ...
  "results": [
    {
      "url": "",
      "name": "Answer",
      "site": "https://daysurface.com/docs",
      "score": 1.0,
    ...
    {
      "url": "https://daysurface.com/docs/mcp/setup",
      "name": "Setup",
      "site": "https://daysurface.com/docs",
      "score": 7.21,
      "description": "...",
      "schema_object": { "@type": "TechArticle", "@context": "https://schema.org", "name": "Setup", "url": "https://daysurface.com/docs/mcp/setup", "description": "...", "text": "..." }
    }
  ]
}
```
...
```bash
curl -N "https://api.daysurface.com/ask?query=How+do+I+set+up+the+MCP+server%3F"
```

```bash
curl -X POST https://api.daysurface.com/ask \
...
| `docs_base_url` | `https://daysurface.com/docs` | Base URL for result links |
