...
This page is the implementation reference. For what the feature does and what a
delivery looks like from a subscriber's side, see
[Gmail webhooks](https://daysurface.com/gmail-webhooks).
